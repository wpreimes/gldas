...
def BatchJob(Files, cookie_jar):
    for dat in Files:
        ...
        Response.close()
    print(
    "Files downloaded to: ", os.path.dirname(os.path.realpath(__file__))
    )
...
username = "wpreimes"
password = "ThisTestPWD1"

# The FULL url of the directory which contains the files you would like to bulk download
url = "https://hydro1.gesdisc.eosdis.nasa.gov/data/GLDAS/GLDAS_CLSM10_M.2.1/2006/"  # Example URL
